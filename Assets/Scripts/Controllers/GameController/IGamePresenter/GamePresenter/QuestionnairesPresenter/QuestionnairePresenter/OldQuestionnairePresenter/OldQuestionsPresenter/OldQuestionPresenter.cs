...
public class OldQuestionPresenter : MonoBehaviour
{
    ...
    private void Awake()
    {
        _answerInputField.onDeselect.AddListener(InputAnswerModel);
        _answerInputField.onSubmit.AddListener(InputAnswerModel);
    ...
    {
        _answerInputField.onDeselect.RemoveListener(InputAnswerModel);
        _answerInputField.onSubmit.RemoveListener(InputAnswerModel);
